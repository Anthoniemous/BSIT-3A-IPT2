...
<head>
    ...
    <title>Princess Gems ✨</title>
    <link href="https://fonts.bunny.net/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="font-sans bg-gradient-to-b from-pink-200 via-yellow-200 to-pink-100">
...
<header class="w-full py-6 bg-white shadow-md sticky top-0 z-50">
    ...
    <section id="home" class="relative">
        <div class="relative w-full h-[85vh] flex items-center justify-center bg-gradient-to-br from-pink-200 via-yellow-200 to-pink-100 overflow-hidden">
            ...
            <div class="relative z-10 text-center max-w-3xl px-6">
                ...
                <p class="text-lg md:text-xl text-pink-800 mb-8">Where pearls meet birthstones — treasures that celebrate <span class="font-semibold">you</span>.</p>
    ...
    <section id="collection" class="py-20 px-6 bg-white">
        <h2 class="text-3xl font-bold text-pink-600 text-center mb-12">Featured Collection</h2>
    ...
    <section id="story" class="py-20 px-6 bg-gradient-to-r from-yellow-100 to-pink-100">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <p class="text-gray-700 text-lg leading-relaxed mb-8">
                Princess Gems started with a simple dream: to make jewelry that is as meaningful as it is beautiful.  
                Every piece is inspired by nature’s treasures — the ocean’s pearls, the earth’s gems, and the stories that connect us all.
            </p>
            <p class="text-pink-700 font-semibold italic">“Not just jewelry, but symbols of love, strength, and identity.”</p>
        </div>
    </section>
    ...
    <section id="contact" class="py-20 px-6 bg-gradient-to-br from-pink-200 via-yellow-200 to-pink-100 text-pink-900">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="mb-10 text-center text-lg">Looking for your birthstone? Have a custom design in mind?  
