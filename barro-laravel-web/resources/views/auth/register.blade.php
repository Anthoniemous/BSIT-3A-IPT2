<x-guest-layout>
    <div class="w-full max-w-md px-8 py-6 bg-white/95 rounded-2xl shadow-2xl">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-extrabold text-blue-900">{{ __('Create an Account') }}</h1>
            <p class="text-sm text-gray-600 mt-1">{{ __('Sign up to get started with your account') }}</p>
        </div>
